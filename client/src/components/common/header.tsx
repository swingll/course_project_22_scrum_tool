      ...
      <div className="container containerDashboard">
        <div className="mainMenu">
          <ul>
            ...
            <Link to="/timeline/1"><li><i className="fas fa-thumbs-up"/><span className="mainMenuText">Timeline</span></li></Link>
            <a rel="noopener noreferrer" target="_blank" href="/timeline/652250087eb001c14029dfaa"><li><i className="fas fa-code-branch" /><span className="mainMenuText">Timeline 2</span></li></a>
